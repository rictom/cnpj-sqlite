...
## Tempo de execução:
Após baixar os arquivos, o processamento levou cerca de 2hs no Windows 10 em um notebook i7 com de oitava geração, 1h30 no Ubuntu no notebook i7 8th, 1h no MacOS com processador M1 e 43 minutos no MacOS com processador M4.
